  ...
  ngOnInit() {
    ...
    combineLatest(
      ...
      ([page, rows, searchValue]) => {
        ...
        // let filtered = this.filterData([...this.data], searchValue);
        let filtered = this.filterData(rows, searchValue);

        console.log(filtered);

        // let paginated = filtered.slice(page * this.pageSize, page * this.pageSize + this.pageSize);

        let paginated = filtered.slice((page - 1) * this.pageSize, page * this.pageSize);
